...
-- | role      | car_system_pages | booking_pages | 
-- | driver    |      true        |    false      |
...
CREATE TABLE car_route_schedule (

    car_route_schedule_id SERIAL PRIMARY KEY,
...
CREATE TABLE booking (
    ...
    car_route_schedule_id INT NOT NULL,
    FOREIGN KEY (car_route_schedule_id) REFERENCES car_route_schedule(car_route_schedule_id)
