        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="text-sm text-left">
              พฤติกรรมผู้ใช้ การจอง ขึ้นรถ ยกเลิก และ No Show
            </p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-left">
              สถิติการจองตามช่วงเวลา ก่อน-หลัง 17:00 น.
            </p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-left">
              สถิติการใช้งานแยกตามประเภทรถและเส้นทาง
            </p>
          </button>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">
                รายงานพฤติกรรมผู้ใช้การใช้งานรถ วันที่ 12 เมษายน 2568 - 15
                เมษายน 2568
              </h3>
            </div>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  ...
                  <tr className="bg-gray-50 font-semibold">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-900 text-center">
                      {mockBookingData.reduce(
                        (sum, item) => sum + item.before17,
                        0
                      )}
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-900 text-center">
                      {mockBookingData.reduce(
                        (sum, item) => sum + item.after17,
                        0
                      )}
                    </td>
                  </tr>
      ...
      {selectedReport === "monthly" && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">
                รายงานจำนวนการมอบหมายงานให้รถแต่ละประเภทในช่วงวันที่ 1 - 30
                เมษายน 2568
              </h3>
            </div>
            <div className="overflow-x-auto">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">
              สรุปแต่ละประเภทรวมรวมดังนี้
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {Object.entries(groupedMonthlyData).map(
                ([vehicleType, vehicles]) => {
                  const totalBookings = vehicles.reduce(
                    (sum, vehicle) => sum + vehicle.bookings,
                    0
                  );
                  return (
                    <div
